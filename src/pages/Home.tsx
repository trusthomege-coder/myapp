...
import { supabase } from '../lib/supabase'; // Импортируем supabase из указанного вами пути
...
          .from('properties') // Используем название таблицы, которое вы указали
          .select('*')
          .eq('is_featured', true) // Используем название колонки, которое вы указали
          .limit(6);
